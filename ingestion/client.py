...
Handles pagination, 429 rate-limiting, and exponential back-off.
"""
...
def _build_session() -> requests.Session:
    ...
    session.headers.update({"AccountKey": cfg.lta_api_key, "accept": "application/json"})
    retry_policy = Retry(total=cfg.max_retries, backoff_factor=cfg.retry_backoff_s,
